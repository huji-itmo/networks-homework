...
- **Hex:** 0xB2699C
- **Байты:** B2 69 9C
- **Биты:** 10110010 01101001 10011100
- **Длина:** 24 бит (3 байт)
...
**Исходное сообщение:** 101100100110100110011100 (24 бит)
**Закодированное сообщение:** 111001010110011110101101011101 (30 бит)
**Избыточность:** 20.0%
...
**Исходное сообщение:** 101100100110100110011100 (24 бит)
**Скремблированное сообщение:** 101101101011000101110101 (24 бит)
**Макс. серия нулей до скремблирования:** 2
...
|-------|-------------|-----------|-----------|--------|-----|
| NRZ | 50.0 | 50.0 | 16.7 | 2 | Да |
| Manchester (IEEE) | 100.0 | 100.0 | 50.0 | 2 | Нет |
| RZ | 100.0 | 100.0 | 25.0 | 3 | Нет |
| AMI | 50.0 | 50.0 | 16.7 | 3 | Нет |
| 4B/5B+NRZ | 62.5 | 62.5 | 25.0 | 2 | Нет |
